# Save in /etc/jupyterhub/jupyterhub_config.py
...
# Set base URL for JupyterHub under NGINX
c.JupyterHub.base_url = '/jupyter'

# Allow all system users to log in
c.Authenticator.allow_all = True

# Create admin user
c.Authenticator.admin_users = {'alice'}

# Bind JupyterHub to localhost on port 8000 (hack to have static IP for WSL inside Zenbook)
